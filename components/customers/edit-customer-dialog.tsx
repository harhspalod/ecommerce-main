...
export function EditCustomerDialog({ customer, open, onOpenChange, onUpdateCustomer }: EditCustomerDialogProps) {
  ...
  useEffect(() => {
    if (customer) {
      ...
      setPurchasedProducts([...customer.purchasedProducts]);
    }
  }, [customer]);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update customer information and manage their complete purchase history.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Add New Product Purchase</CardTitle>
              <CardDescription>Add additional products that this customer has purchased</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit">
              Update Customer {purchasedProducts.length > 0 && `(${purchasedProducts.length} products)`}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
